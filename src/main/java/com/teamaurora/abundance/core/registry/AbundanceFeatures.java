...
public class AbundanceFeatures {
    ...
    public static final class Configured {
        ...
        public static void registerConfiguredFeatures() {
            ...
            register("trees_jacaranda_sparse", TREES_JACARANDA_SPARSE);
