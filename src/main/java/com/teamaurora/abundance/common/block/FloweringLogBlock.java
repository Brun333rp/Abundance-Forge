...
public class FloweringLogBlock extends AbnormalsLogBlock {

    private final Supplier<Block> snipBlock;

    public FloweringLogBlock(Supplier<Block> snippedBlock, Supplier<Block> strippedBlock, Properties properties) {
